...
namespace Dal_Planilha
{
    public class CriarPlanilhaDal
    {
        ...
        public void NovaPlanilha(int Ano, int Cod)
        {
            ...
            MySqlCommand Res = new MySqlCommand("INSERT INTO "+Cod+"tbl_resultado(pl_ano, pl_propResultado, pl_realiResultado, cod_categoria) VALUES (@Ano, 0, 0, 1), (@Ano, 0, 0, 2), (@Ano, 0, 0, 3), (@Ano, 0, 0, 4), (@Ano, 0, 0, 5), (@Ano, 0, 0, 6), (@Ano, 0, 0, 7), (@Ano, 0, 0, 8), (@Ano, 0, 0, 9), (@Ano, 0, 0, 10)");
